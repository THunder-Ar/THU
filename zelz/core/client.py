                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @DAD_E3DAM\
                                  \n\n--------بـدء تتبـع سجـل ثانــدر 𝗧𝗛𝘂𝗻𝗱𝗲𝗿--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ثانــدر 𝗧𝗛𝘂𝗻𝗱𝗲𝗿--------"
                        ...
                        link = "[『 َِٓ𝗘َِ𝟯َِٓ𝗗َِٓ𝗔َِٓ𝗠َِٓ ℡ 』 ☬ ➥ مٓمٓــۄل ||](https://t.me/DAD_E3DAM)"
                        text = (
                            "**✘ تقـريـر اشعـار ثانــدر 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ثانــدر 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 ✘**\n\n "
                        link = "[『 َِٓ𝗘َِ𝟯َِٓ𝗗َِٓ𝗔َِٓ𝗠َِٓ ℡ 』 ☬ ➥ مٓمٓــۄل ||](https://t.me/DAD_E3DAM)"
