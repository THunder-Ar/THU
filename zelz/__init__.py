...
__version__ = "3.3.2"
__license__ = "حقـوق سـورس ثانــدر"
__author__ = "ثانــدر <https://T.me/SOURCE_THUNDER>"
__copyright__ = "THunder Source (C) 2020 - 2024  " + __author__

zedub.version = __version__
LOGS = logging.getLogger("ثانــدر")
bot = zedub
...
if Config.UPSTREAM_REPO == "zel":
    UPSTREAM_REPO_URL = "https://github.com/THunder-Ar/THU"
else:
