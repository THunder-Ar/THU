# 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 - E3DAM
# Copyright (C) 2023 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 . All Rights Reserved
""" 
Logo & Style for 𝗧𝗛𝘂𝗻𝗱𝗲𝗿™ t.me/SOURCE_THUNDER
Write file by E3DAM t.me/DAD_E3DAM
...
async def lg1(userevent):
    ...
    if gvarstatus("ZED_FONTS") is None: # code by t.me/DAD_E3DAM
    ...
    if arabic_text: # code by t.me/DAD_E3DAM
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/DAD_E3DAM
