#𝗧𝗛𝘂𝗻𝗱𝗲𝗿 ®
#الملـف حقـوق وكتابـة المطور اعدام ⤶ @DAD_E3DAM خاص بسـورس ⤶ 𝗧𝗛𝘂𝗻𝗱𝗲𝗿
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 𓆪 </b> - @SOURCE_THUNDER "
...
async def who(event):
    ...
    if replied_user.id in zel_dev:
       return await edit_or_reply(zed, "**- دي . . انـهُ المطور . . انتـه الحيـوان يوصخ**")
    if replied_user.id == 7067639607:
       return await edit_or_reply(zed, "**- يغبي . . انـهُ المطـور . . انتـه الحيـوان يوثخ**")
