...
#الملـف كتابـة المطور اعدام ⤶ @DAD_E3DAM خاص بسـورس ⤶ 𝗧𝗛𝘂𝗻𝗱𝗲𝗿
...
async def _(event):
    ...
    async with borg.conversation(chat) as conv: # code by t.me/DAD_E3DAM
        try:
...
async def linkapk(event):
    ...
    if input_str == "الحذف":
        return
    chat = "@apkdl_bot" # code by t.me/DAD_E3DAM
