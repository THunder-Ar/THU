...
ZelzalDV_cmd = (
    "[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 - اوامــر المطـور المســاعد](t.me/SOURCE_THUNDER) .\n\n"
    ...
    "\n𓆩 [𝗧𝗛𝘂𝗻𝗱𝗲𝗿 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/SOURCE_THUNDER) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**⎉╎يتم الان اعـادة تشغيـل بـوت ثانــدر انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**⎉╎يتم الان اعـادة تشغيـل بـوت ثانــدر انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
...
# Copyright (C) 2022 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 . All Rights Reserved
