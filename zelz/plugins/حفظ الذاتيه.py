...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗧𝗛𝘂𝗻𝗱𝗲𝗿 - حفـظ الذاتيـه 🧧](t.me/SOURCE_THUNDER) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝙕𝞝𝘿](t.me/SOURCE_THUNDER) 𓆪"
)
