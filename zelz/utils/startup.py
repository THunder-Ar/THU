# THunder
# Copyright (C) 2022 THunder . All Rights Reserved
#< https://t.me/SOURCE_THUNDER >
...
Zed_Vip = (7067639607)
Zed_Dev = (7067639607)
zchannel = {"@SOURCE_THUNDER, @CG_G11"}
...
async def autovars(): #Code by T.me/DAD_E3DAM
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/46ed75914ff6ef9b89b05.mp4",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس ثانــدر الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝗧𝗛𝘂𝗻𝗱𝗲𝗿 𓏣", "https://t.me/SOURCE_THUNDER"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
